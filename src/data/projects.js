...
export const projects = [
   ...
   },
   {
      ...
      rating: 3,
      desc:
         "Prototype of Suite Project, an app that makes finding accommodation easier.",
      totalMinutes: 4,
      postedAt: 1604647411379,
      githubUrl: "https://github.com/jysfc/jay-yao-portfolio",
      image: "walkthrough-of-suite-project-prototype.webp",
      youtubeUrl: "//youtu.be/PTpVOe1NjpQ",
      isActive: true,
   },
   {
      id: "cb9f3b9a-c3df-4816-b46c-6eec1cc9af59",
      title: "Calling data from API and storing in Redux - Suite Project",
      rating: 5,
      desc:
         "Calling data from API and storing it in Redux inside Suite Project",
      totalMinutes: 4,
      postedAt: 1608267854073,
      githubUrl: "https://github.com/jysfc/jay-yao-portfolio",
      image: "calling-data-from-apiI-and-storing-in-redux -suite-project.webp",
      youtubeUrl: "//youtu.be/mh4mZox05QM",
      isActive: true,
   },
];
